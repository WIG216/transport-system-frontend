          ...
          <div class="lg:w-1/3 md:w-1/4 p-6 w-full shadow-lg shadow-slate-300">
            <a class="block relative h-48 rounded overflow-hidden">
              <img
                alt="ecommerce"
                class="object-cover object-center w-full h-full block"
                src="https://images.cars.com/cldstatic/wp-content/uploads/09-tesla-model-3-2018-dynamic--exterior--rear-angle--red.jpg"
              />
            </a>
            <div class="mt-4">
              <h2 class="text-gray-900 title-font text-lg font-medium">
          ...
          <div class="lg:w-1/3 md:w-1/4 p-6 w-full shadow-lg shadow-slate-300">
            <a class="block relative h-48 rounded overflow-hidden">
              <img
                alt="ecommerce"
                class="object-cover object-center w-full h-full block"
                src="https://i.insider.com/5ddc634dfd9db26c9145d524?width=700"
              />
            </a>
            <div class="mt-4">
              <h2 class="text-gray-900 title-font text-lg font-medium">
