...
function TextInput({ type, name, placeholder, value, onChange, onBlur }) {
    return (
        <div className="relative z-0 w-full mb-6 border-b border-gray-600">
            <input onBlur={onBlur} onChange={onChange} type={type} name={name} className="block py-2.5 px-0 w-full text-base focus:outline-none focus:ring-0 focus:border-slate-800 peer text-gray-800" placeholder=" " />
